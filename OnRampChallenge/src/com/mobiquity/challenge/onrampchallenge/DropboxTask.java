...
public class DropboxTask extends AsyncTask<Void, Void, Void>{
	...
	private static final String AUDIO_DIRECTORY="/OnRampAudio/";
	private static final String IMAGE_DIRECTORY="/OnRampImages/";
	private static final String TEXT_NOTES_DIRECTORY="/OnRampText/";
	...
	private void putFileInDirectory(File file, FileInputStream inputStream,String directory)
		...
		Entry response = LoginActivity.mDBApi.putFile(directory+""+fileName, inputStream,
